...
import { applyEvent, INITIAL_PROJECTION_STATE, createProjectionState } from '../../src/projection/reducer'
import { createInitialState, deepFreeze } from '../../src/core/immutable'
