...
/aegis-runtime/        AEGIS-Ω Seven-Pillar distributed agent swarm runtime — StateAnchor, DomainFirewall, AffineCanvas, SemanticGraph, ValidationDFA, GossipEmitter, HysteresisFilter (T2)
