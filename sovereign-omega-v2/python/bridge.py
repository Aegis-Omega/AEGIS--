    ...
    def do_POST(self):
        ...
        if self.path == '/gate_signal':
            ...
            CONSTITUTIONAL_SYSTEM = (
                ...
                '  5. VIABILITY: every substantive claim must carry its epistemic tier\n\n'
                ...
                'T3 — Research conjecture. Plausible, no validation yet.\n'
                ...
                '  Before complex claims: PERCEIVE (verify the signal) → ASSESS (classify tier)\n'
                ...
                'For simple questions: answer directly. The architecture emerges through HOW you reason.\n'
                'For complex reasoning: show tier progression and your weakest point.\n\n'
