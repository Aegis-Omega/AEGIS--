...
function deptOutput(obj: string, mode: Mode, dept: Dept): string {
  ...
  const templates: Record<Mode, Record<string, string>> = {
    revenue: {
      ...
      Support:     `Support: email-first (info@aegisomega.com). SLA: 48h. Self-serve docs at aegis-vertex.aegisomega.com/docs.`,
    ...
    gtm: {
      ...
      Product: `GTM product: live API at aegis-vertex.aegisomega.com. Free explorer at /pricing. Custom domain provisioning.`,
      UX: `GTM UX: onboarding must be <2 minutes. Email → key → first call. No friction before value is demonstrated.`,
      Data: `GTM metrics: week 1 goal: 50 explorer signups, 5 operator sales ($245). PostHog tracking LIVE.`,
      API: `GTM API: docs at aegis-vertex.aegisomega.com/docs. OpenAPI spec on launch day. Python SDK: week 4.`,
    ...
    fundraising: {
      ...
      Product: `Fundraising product: investors want to see a live product, not a demo. aegis-vertex.aegisomega.com is live.`,
